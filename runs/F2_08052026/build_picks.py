...
PICKS = {
 ...
 "08-05-b09": {"url":"https://www.tiktok.com/@lorifullbright/video/7530796393783446798","platform":"tiktok",
   "title":"Scammers are pretending to be Amazon again — fake recall/refund text","uploader":"Lori Fullbright",
   "source_type":"first_person","score":83,
   "segments":[("0:00","these are criminals")],
   "reasoning":"Verified genuinely vertical (1080x1920, confirmed via yt-dlp dimensions) native TikTok post. Lori Fullbright is a real on-air crime/consumer reporter posting a direct, face-to-camera safety-tip video on her personal account — not a produced screen-record-plus-voiceover explainer. She names the exact scam (fake Amazon quality-inspection/recall text offering a no-return refund) and delivers the core warning plainly in the first 35 seconds. Matches 'HERE YOU CAN SEE ONE OF THESE TEXTS LAND' in tone if not literally (she describes it rather than showing the text on screen), but is the strongest genuine first-person vertical material found.",
   "flags":["describes the scam text rather than screen-recording it landing; found via direct site:tiktok.com Brave web-search query, not the bulk pipeline pass, which returned zero native TikTok candidates for this beat"]},
