...
REPLACE = [
 ...
 # b05 — Erin West dropped entirely. She never said either scripted line, and
 # once those went the beat was topically adrift: her work is Southeast Asian
 # pig-butchering compounds, while both victims in this segment wired to Mexico.
 # Replaced with the FBI's former lead kidnapping negotiator on virtual
 # kidnapping itself, answering the question two victim stories leave hanging.
 ("THE WOMAN CHASING THESE GUYS CALLS THIS A SCAMDEMIC",
  "SO WHY DIDN'T THEY JUST HANG UP? HERE IS THE REAL ANSWER"),
 ("-ERIN WEST RUNS AN ORGANIZATION CALLED OPERATION SHAMROCK THAT FIGHTS THIS INDUSTRY.",
  "-YOU ARE SITTING THERE RIGHT NOW THINKING YOU WOULD NEVER FALL FOR THIS."),
 ("-SHE SAYS A FEW SECONDS OF YOUR VOICE PRODUCES SOMETHING THAT SOUNDS EXACTLY LIKE YOU.",
  "-CHRIS VOSS WAS THE F-B-I'S LEAD INTERNATIONAL KIDNAPPING NEGOTIATOR."),
 ("-AND SHE GIVES YOU THE CLEANEST TEST OUT THERE FOR ANY SCAM CALL.",
  "-HE SAYS THESE GUYS KNOW IN THE FIRST TEN SECONDS WHETHER THEY HAVE GOT YOU."),
 ("-ANXIETY... PLUS IMMEDIATE ACTION... PLUS MOVING MONEY.",
  "-AND ONCE THEY DO, SOMETHING PHYSICALLY CHANGES IN YOUR BRAIN."),
 ("-YOU GET ALL THREE AT ONCE, IT IS A SCAM. EVERY TIME!!",
  "-YOU STOP BEING ABLE TO THINK STRAIGHT. THAT IS NOT STUPIDITY, THAT IS CHEMISTRY!!"),
 ("-LET HER EXPLAIN WHY SHE THINKS THIS ONLY GETS WORSE FROM HERE.",
  "-LISTEN TO HIM EXPLAIN WHAT IS ACTUALLY HAPPENING TO YOU ON THAT CALL."),
 ("(((B05 - EXPERT - ERIN WEST, OPERATION SHAMROCK / SCAMDEMIC / ANXIETY-ACTION-MONEY TEST / BUTT FROM B04, SAME PACKAGE)))",
  "(((B05 - EXPERT - CHRIS VOSS, FORMER F-B-I LEAD KIDNAPPING NEGOTIATOR / WHY THE BRAIN STOPS WORKING ON THESE CALLS / STANDALONE SOURCE, NOT A BUTT FROM B04)))"),
 # b06 — "police warn" is a PSA by construction and the supplied clip ended on
 # "complaint center." Rebuilt as scope rather than advice: four districts at
 # once, then a college football roster.
 ("NOW POLICE IN KANSAS ARE WARNING WHOLE NEIGHBORHOODS ABOUT THIS!",
  "THEY ARE WORKING THROUGH WHOLE SCHOOL DISTRICTS NOW"),
 ("-THE OLATHE, KANSAS POLICE DEPARTMENT SAYS IT HAS TAKEN MULTIPLE REPORTS OF THIS EXACT CALL.",
  "-THIS IS NOT RANDOM ANYMORE. THEY ARE GOING SCHOOL BY SCHOOL."),
 ("-THE SCRIPT IS ALWAYS THE SAME... YOUR CHILD WAS IN A CRASH, AND NOW WE HAVE THEM.",
  "-OUTSIDE PORTLAND, FOUR DISTRICTS PUT OUT THE SAME WARNING AT THE SAME TIME."),
 ("-THEY DEMAND MONEY IMMEDIATELY AND THEY MAKE VIOLENT THREATS!!",
  "-THEY CALLED PARENTS OF GRADE SCHOOLERS AND SPOKE THEIR OWN LANGUAGE BACK TO THEM."),
 ("-AND THEY PLAY SOMETHING THAT SOUNDS LIKE THE CHILD'S VOICE.",
  "-AND THEY PLAYED A CHILD'S VOICE UNDERNEATH IT. THAT PART IS THE A-I."),
 ("-HERE IS WHAT POLICE WANT EVERY PARENT AND GRANDPARENT TO KNOW.",
  "-WATCH HOW ORGANIZED THIS IS."),
 ("(((B06 - POLICE WARNING - OLATHE KANSAS PD / MULTIPLE REPORTS / CRASH-THEN-KIDNAP SCRIPT / VIOLENT THREATS / KCTV 02-03-26)))",
  "(((B06 - SCOPE - KGW PORTLAND / FOUR SCHOOL DISTRICTS WARNING AT ONCE + FIVE OREGON STATE FOOTBALL FAMILIES / A-I CHILD VOICE / GARY OVERMAN)))"),
...
INSERT_AFTER = [
 ...
 # b05 needs eight lines where the original had six.
 ("-YOU STOP BEING ABLE TO THINK STRAIGHT. THAT IS NOT STUPIDITY, THAT IS CHEMISTRY!!",
  ["-HE SAYS THEY CAN ONLY HOLD YOU IN THAT STATE ABOUT AN HOUR AND A HALF.",
   "-RACHEL WAS ON FOR TWO HOURS. DEBORAH WAS ON FOR FIVE!!"]),
 # b06 needs eight lines where the original had five.
 ("-AND THEY PLAYED A CHILD'S VOICE UNDERNEATH IT. THAT PART IS THE A-I.",
  ["-THEN THEY WENT STRAIGHT AT A COLLEGE FOOTBALL ROSTER.",
   "-FIVE OREGON STATE FAMILIES GOT THE CALL. ONE OF THEM PAID!!",
   "-GARY OVERMAN'S SON JAKE WAS HOME ON BREAK THE WHOLE TIME."]),
